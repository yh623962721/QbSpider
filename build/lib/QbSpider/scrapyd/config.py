...
class Config(object):
    ...
    def __init__(self, values=None, extra_sources=()):
        if values is None:
            ...
            default_config = get_data(__package__, 'scrapyd.conf')
    ...
    def items(self, section, default=None):
        ...
        try:
            # parse scrapyd.config file , get section (for example services,scrapyd&&) and return a list of tuple with (name,value) for each option in section
