...
class Root(resource.Resource):
    ...
    def __init__(self, config, app):
        ...
        self.app = app
        #get machine hostname or you can define yourself hostname in scrapyd.conf like node_name = ******** &&
        self.nodename = config.get('node_name', socket.gethostname())
        #give '' means that put child root of a folder
        self.putChild('', Home(self, local_items))
        if logsdir:
            #create folder logs and read use text
        ...
        #read some jsonrpc service from config
