...
class getColumnDescriptors_result(object):
    ...
    thrift_spec = (
        (0, TType.MAP, 'success', (TType.STRING, 'BINARY', TType.STRUCT, (ColumnDescriptor, ColumnDescriptor.thrift_spec), False), None, ),  # 0
        (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ),  # 1
    )
...
class getTableRegions_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (TRegionInfo, TRegionInfo.thrift_spec), False), None, ),  # 0
        (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ),  # 1
    )
...
class createTable_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'tableName', 'BINARY', None, ),  # 1
        (2, TType.LIST, 'columnFamilies', (TType.STRUCT, (ColumnDescriptor, ColumnDescriptor.thrift_spec), False), None, ),  # 2
    )
...
class get_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (TCell, TCell.thrift_spec), False), None, ),  # 0
        (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ),  # 1
    )
...
class getRow_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (TRowResult, TRowResult.thrift_spec), False), None, ),  # 0
        (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ),  # 1
    )
...
class mutateRow_args(object):
    ...
    thrift_spec = (
        ...
        (1, TType.STRING, 'tableName', 'BINARY', None, ),  # 1
        (2, TType.STRING, 'row', 'BINARY', None, ),  # 2
        (3, TType.LIST, 'mutations', (TType.STRUCT, (Mutation, Mutation.thrift_spec), False), None, ),  # 3
        (4, TType.MAP, 'attributes', (TType.STRING, 'BINARY', TType.STRING, 'BINARY', False), None, ),  # 4
    )
...
class mutateRows_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'tableName', 'BINARY', None, ),  # 1
        (2, TType.LIST, 'rowBatches', (TType.STRUCT, (BatchMutation, BatchMutation.thrift_spec), False), None, ),  # 2
        (3, TType.MAP, 'attributes', (TType.STRING, 'BINARY', TType.STRING, 'BINARY', False), None, ),  # 3
    )
...
class incrementRows_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'increments', (TType.STRUCT, (TIncrement, TIncrement.thrift_spec), False), None, ),  # 1
    )
