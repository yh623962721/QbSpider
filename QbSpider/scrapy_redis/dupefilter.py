...
class RFPDupeFilter(BaseDupeFilter):
    ...
    def __init__(self, server, key, debug=False, use_duplicate=False):
    ...
    def from_settings(cls, settings):
        ...
        use_duplicate = settings.getbool('USE_DUPLICATE')
        return cls(server, key=key, debug=debug, use_duplicate=use_duplicate)
